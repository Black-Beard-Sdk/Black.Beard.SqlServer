...
{
    public class ListNamedModelDescriptor<T> : NamedModelDescriptor, IList<T>, IList, IReadOnlyList<T>
    where T : ModelDescriptor
    {


        public ListNamedModelDescriptor(int capacity)
        {
            this._items = new List<T>(capacity);
        }

        public ListNamedModelDescriptor()
        {
            this._items = new List<T>();
        }

        public ListNamedModelDescriptor(IEnumerable<T> collection)
        {
